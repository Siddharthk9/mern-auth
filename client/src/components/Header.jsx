...
export default function Header() {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <p className='mb-8 max-w-md'>Let's start with a quick product tour and we will have you uo and running in no time!</p>
      <button className='border border-gray rounded-full px-2 py-2 hover:bg-gray-500 transition-all'>Get Started</button>
    </div>
  )
}
